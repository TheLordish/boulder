...
var SHELL = [
  ...
  "./js/comp.js?v=" + VER, "./js/foods.js?v=" + VER, "./js/docs.js?v=" + VER, "./js/extras.js?v=" + VER, "./js/photos.js?v=" + VER, "./js/native.js?v=" + VER, "./js/entry.js?v=" + VER, "./js/app.js?v=" + VER, "./js/views2.js?v=" + VER,
  "./js/shell.js?v=" + VER, "./js/main.js?v=" + VER,
  "./manifest.webmanifest?v=" + VER,
  "./data/regional.json", "./icons/icon.svg", "./icons/icon-192.png", "./icons/icon-512.png",
